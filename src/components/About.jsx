...
const About = () => {
    ...
    return (
        <section
            ref={containerRef}
            id="about"
            className="min-h-[80vh] w-full bg-[#D1D1D1] flex flex-col justify-center px-4 md:px-12 py-32 border-b border-black select-none"
        >
            {/* Unified About Card Block Container with Hard Drop Shadow */}
            <div className="relative w-full max-w-[95%] mx-auto bg-[#D1D1D1] border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">

                {/* Top Grid Container */}
                <div className="relative w-full p-8 md:p-16 min-h-[500px] flex items-center border-b-2 border-black">
                ...
                <div className="w-full grid grid-cols-2">
                    <div className="p-4 border-r-2 border-black flex items-center gap-4">
